      ...
      <div class="container-fluid">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              <!-- form start -->
              <form action ="${pageContext.request.contextPath }/adminInsert.admin" method ="post" name="frm">
                
                <!-- 작업 -->
         <table class ="tbl" border="1">
			<tr>
				<td class="tdcol">관리자 아이디</td>
				<td class="tdcol2">
						<input class = textbox_size type="text" name="manager_id">
				</td>
			</tr>
			<tr>
				<td class="tdcol">관리자 비밀번호</td>
				<td class="tdcol2">
						<input class = textbox_size type="password" name="mg_pw">
				</td>
			</tr>
		</table>
