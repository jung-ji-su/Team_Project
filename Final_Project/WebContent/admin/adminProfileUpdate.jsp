      ...
      <div class="container-fluid">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              <!-- form start -->
              <form action ="${pageContext.request.contextPath }/profileUpdate.admin" method ="post" name="frm" encType = "multipart/form-data">
                
                <!-- 작업 -->
         <table class ="tbl" border="1">
			<tr>
				<td class="tdcol">변경할 관리자 이름</td>
				<td class="tdcol2">
						<input class = textbox_size type="text" name="mg_name">
				</td>
			</tr>
			<tr>
				<td class="tdcol">프로필 이미지</td>
				<td>
					<input type="file" name="mg_img">
				</td>
			</tr>
