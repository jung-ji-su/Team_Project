...
<html>
  ...
  <body>
  	...
  	<c:set var="categoryCnt" value="${requestScope.categoryCnt }"/>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-6 order-1 align-self-end">
            <img src="images/we/cate${category}.png" alt="Image" class="img-fluid">
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="container">
        ...
        <div class="row mb-5">
          <div class="col-md-9 order-1">  <!--  -->
            ...
            <h1 class="category_title"> <a href="${pageContext.request.contextPath }/getcategory.shop?category=${category}">${titles[category-1]}</a></h1>
            <div class="row mb-5"> 
            
				<c:forEach var="list_category" items="${list_category}">
	              <div class="col-lg-6 col-md-6 item-entry mb-4">
	                <a href="${pageContext.request.contextPath }/shop-single.shop?product_id=${list_category.product_id}" class="product-item md-height bg-gray d-block">
	                  <img src="${list_category.product_imgpath }" alt="Image" class="img-fluid">
	                </a>
	                <h2 class="item-title"><a href="${pageContext.request.contextPath }/shop-single.shop?product_id=${list_category1.product_id}">${list_category.product_name }</a></h2>
	                <strong class="item-price"><fmt:formatNumber type="number" maxFractionDigits="3" value="${list_category.product_price}" /></strong>
	              </div>
              	</c:forEach>
            ...
            <div class="row">
              <div class="col-md-12 text-center">
                <div class="site-block-27">
                  <ul>
                  	<c:if test="${nowPage > 1 }">
                    	<li><a href="${pageContext.request.contextPath }/getcategory.shop?category=${category}&page=${nowPage-1}">&lt;</a></li>
                    </c:if>
					<c:forEach var="i" begin="${startPage}" end="${endPage }">
						<c:choose>
							...
							<c:otherwise>
								<li><a href="${pageContext.request.contextPath }/getcategory.shop?category=${category}&page=${i}">${i}</a></li>
							</c:otherwise>
	                    </c:choose>
                    </c:forEach>
